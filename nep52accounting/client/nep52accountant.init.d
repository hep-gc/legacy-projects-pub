...
#
# chkconfig:    345 85 15
# description:  nep52 accoutant process that extracts the information from the condor history file
#
### BEGIN INIT INFO
# Provides:          nep52accountant
...
# Short-Description: nep52 accoutant process that extracts the information from the condor history file
# Description:       
### END INIT INFO

EXECUTABLEPATH="/usr/local/nep52accountant/bin/nep52accountant" 

# Non-default python (eg. if you installed python 2.6 on RHEL5)
PYTHON=""

# You probably won't want to change these.
SERVICE=nep52accountant
